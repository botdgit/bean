-- BEAN — Supabase initial setup bundle.
--
-- Generated snapshot of:
--   supabase/migrations/0001_init.sql
--   supabase/migrations/0002_stripe_customer.sql
--   supabase/seed.sql
--
-- Paste this whole file into Supabase Dashboard → SQL Editor → Run.
-- One-shot: only run against an empty `public` schema. If you switch to the
-- Supabase CLI later, run `npx supabase migration repair --status applied
-- 0001 0002` so the CLI knows these are already in place.
--
-- WARNING: if you change either migration in `supabase/migrations/`,
-- regenerate this bundle (it is a snapshot, not the source of truth).
